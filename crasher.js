...
    return false;
  }
  const vsSource = #version 300 es &nbsp;&nbsp;&nbsp;&nbsp;in vec2 a_position; &nbsp;&nbsp;&nbsp;&nbsp;void main() { gl_Position = vec4(a_position, 0.0, 1.0); };
  const fsSource = #version 300 es &nbsp;&nbsp;&nbsp;&nbsp;precision highp float; &nbsp;&nbsp;&nbsp;&nbsp;out vec4 fragColor; &nbsp;&nbsp;&nbsp;&nbsp;uniform vec2 u_resolution; &nbsp;&nbsp;&nbsp;&nbsp;uniform float u_time; &nbsp;&nbsp;&nbsp;&nbsp;float trigHell(vec3 p) { &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;float v = 0.0; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;float amp = 1.0; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for (int i = 0; i < 110; i++) { &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;v += amp * sin(p.x * 13.7 + u_time * 2.4); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;v += amp * cos(p.y * 16.9 + u_time * 2.8); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;v += amp * tan(atan(p.z * 10.3 + u_time * 1.6) * 1.4); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;v += amp * sin(cos(tan(v * 4.1)) * 5.3); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;v = fract(v * 1.6180339887); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;amp *= 0.39; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;p += vec3(sin(u_time * 0.9), cos(u_time * 1.3), tan(u_time * 0.7)); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return v; &nbsp;&nbsp;&nbsp;&nbsp;} &nbsp;&nbsp;&nbsp;&nbsp;void main() { &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vec2 uv = (gl_FragCoord.xy - u_resolution * 0.5) / u_resolution.y; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vec3 ro = vec3(sin(u_time * 0.8) * 5.0, cos(u_time * 1.0) * 4.0, -10.0); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vec3 rd = normalize(vec3(uv * 2.2, 1.9 + sin(u_time * 0.5) * 0.5)); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;float dist = 0.0; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;float accum = 0.0; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for (int i = 0; i < 420; i++) { &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vec3 p = ro + rd * dist; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;float density = abs(trigHell(p * 3.8 + u_time * 1.6)) * 0.12; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;accum += density * exp(-dist * 0.018); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;accum += sin(dist * 22.0 + u_time * 7.0) * cos(dist * 15.0) * 0.035; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dist += max(0.05, density * 0.42); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (dist > 80.0 || accum > 10.0) break; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vec3 col = 0.5 + 0.5 * vec3( &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sin(accum * 5.1 + u_time * 2.4), &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cos(accum * 6.8 + u_time * 2.1), &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tan(accum * 4.7 + u_time * 1.2) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fragColor = vec4(col, 1.0); &nbsp;&nbsp;&nbsp;&nbsp;};
...
    worker = new Worker(URL.createObjectURL(new Blob([ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;onmessage = function(e) { &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (e.data[0] === "ping") postMessage(["pong"]); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}; &nbsp;&nbsp;&nbsp;&nbsp;], {type: 'text/javascript'})));
  } catch (e) {}
  // Resize handling
